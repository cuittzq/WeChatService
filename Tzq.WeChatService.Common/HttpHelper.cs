// ***********************************************************************
// <copyright file="HttpHelper.cs" company="四川全球通">
// Copyright (c) 四川全球通. All rights reserved.</copyright>
// Assembly         : Tzq.WeChatService.Common
// Author            : 谭志强
// Created          : 2015/7/27 10:45:48
// <summary></summary>
// ***********************************************************************
...
namespace Tzq.WeChatService.Common
{
    public static class HttpHelper
    {
        ...
        /// <returns></returns>
        public static string FilePostRequest(string url, string filePath)
        {
            ...
            var header = string.Format(headerTemplate, fileHeaderName, filePath);
            var headerbytes = System.Text.Encoding.UTF8.GetBytes(header);
            stream.Write(headerbytes, 0, headerbytes.Length);
